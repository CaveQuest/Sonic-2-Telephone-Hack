...
OSN_MoveIn:
		...
		move.w	#$00BE,d0				; set to play spinning SFX
...
; ---------------------------------------------------------------------------
ObjSon00:	dc.w	$0004
		dc.b	$EB,$0D,$00,$00,$00,$00,$FF,$EC
		dc.b	$FB,$09,$00,$08,$00,$00,$FF,$EC
		dc.b	$FB,$06,$00,$0E,$00,$00,$00,$04
		dc.b	$0B,$04,$00,$14,$00,$00,$FF,$EC
ObjSon01:	dc.w	$0002
		dc.b	$EC,$0D,$00,$00,$00,$00,$FF,$ED
		dc.b	$FC,$0E,$00,$16,$00,$00,$FF,$F5
ObjSon02:	dc.w	$0002
		dc.b	$ED,$09,$00,$22,$00,$00,$FF,$F3
		dc.b	$FD,$0A,$00,$28,$00,$00,$FF,$F3
ObjSon03:	dc.w	$0004
		dc.b	$EB,$09,$00,$22,$00,$00,$FF,$F4
		dc.b	$FB,$09,$00,$31,$00,$00,$FF,$EC
		dc.b	$FB,$06,$00,$37,$00,$00,$00,$04
		dc.b	$0B,$04,$00,$3D,$00,$00,$FF,$EC
ObjSon04:	dc.w	$0002
		dc.b	$EC,$09,$00,$22,$00,$00,$FF,$F3
		dc.b	$FC,$0E,$00,$3F,$00,$00,$FF,$EB
ObjSon05:	dc.w	$0003
		dc.b	$ED,$0D,$00,$00,$00,$00,$FF,$EC
		dc.b	$FD,$0C,$00,$4B,$00,$00,$FF,$F4
		dc.b	$05,$09,$00,$4F,$00,$00,$FF,$F4
		even
; ---------------------------------------------------------------------------
; ===========================================================================
; ---------------------------------------------------------------------------
...
OS_PlaySound:
		addq.b	#$02,$24(a0)				; increase routine counter
		move.w	#$00BC,d0				; set to play spin release SFX
		jsr	PlaySound				; play SFX
...
OS_SpinIn:
		...
		addq.b	#$02,$24(a0)				; increase routine counter
		move.w	#$00BD,d0				; set to play spiked chandelier SFX
		jsr	PlaySound				; play SFX
...
; ---------------------------------------------------------------------------
ObjLet_SSRG:	dc.w	$0001
		dc.b	$F0,$0F,$00,$00,$00,$00,$FF,$F0
		even
; ---------------------------------------------------------------------------
; ===========================================================================
; ---------------------------------------------------------------------------
